          ...
          {(isGlobalLoading) => (
            <>
              ...
              <SignIn.Step name="choose-strategy">
                <Card className="w-full sm:w-96">
                  <CardHeader>
                    <CardTitle>Используйте другой метод</CardTitle>
                    <CardDescription>
                      Возникли проблемы? Вы можете использовать любой из этих методов для входа.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="grid gap-y-4">
                  ...
                  <Card className="w-full sm:w-96">
                    ...
                    <CardContent className="grid gap-y-4">
                      <Clerk.Field name="code">
                        <Clerk.Label className="sr-only">Код подтверждения на почту</Clerk.Label>
